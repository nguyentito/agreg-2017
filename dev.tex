...
\begin{proposition}
  ...
  \begin{tikzcd}[column sep=large]
    ...
    \ar[r, "\widehat{\phi}"] & F \ar[d, "\phi(g)(-)\phi(g)^{-1}"] \\
    \{1,\ldots,6\} \ar[r, "e"] & E \ar[r, "\widehat{\phi}"] & F
  \end{tikzcd}
  \end{center}
\end{proposition}
\begin{proof}
...
\begin{tikzcd}[column sep=large]
  \{1,\ldots,6\} \ar[d, "g"] \ar[r, "\widehat{\phi^{-1}} \circ e"] 
  & F \ar[d, "g(-)g^{-1}"] \\
  \{1,\ldots,6\}\ar[r, "\widehat{\phi^{-1}} \circ e"] & F 
\end{tikzcd}
